<h1 align="center"><a  href="http://rochernikov.github.io/camera-repair-service/" target="_blank"><img src="./readme_src/camera-repair-service_header.png" width="100%" alt="Шапка"></a></h1>

## Краткое описание:

<p align="Left"> Лендинг сервисного центра по ремонту пленочных фотоаппаратов.</p>
...
`$ git clone git@github.com:RoChernikov/camera-repair-service.git`
...
- [Ссылка на GitHub Pages](http://rochernikov.github.io/camera-repair-service/)
